...
test:
	...
	gcc -I ./include/ -L ./lib/ -Wl,-rpath,./lib/ ./examples/test_main.c ./src/stack.c ./src/util.c ./src/insert_functions.c ./src/init_destroy_funcs.c ./src/sofo.c ./src/galanis.c ./src/pantelis.c -lbf -o ./build/test_main
